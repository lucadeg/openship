...
| `GET /api/cloud/github/install-callback` | public | GitHub install callback — atomically claim a durable user/workspace nonce after matching user-token and Openship App-JWT verification. |
